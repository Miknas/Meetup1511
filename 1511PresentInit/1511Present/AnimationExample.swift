...
struct AnimationExample: View {
        ...
        var body: some View {
            GeometryReader { proxy in
                ZStack(alignment: .topLeading) {
                    ...
                    InfinityShape().stroke(Color.blue, style: StrokeStyle(lineWidth: 5, lineCap: .round, lineJoin: .miter, miterLimit: 0))
    ...
    struct FollowEffect: GeometryEffect {
        ...
        func percentPoint(_ percent: CGFloat) -> CGPoint {
            ...
            let from = pct > 0.999 ? CGFloat(1-0.001) : pct
            let to = pct > 0.999 ? CGFloat(1) : pct + 0.001
